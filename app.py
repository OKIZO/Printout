...
# レイアウトを少しでも広く使うための設定
st.set_page_config(page_title="MedConcept PPTX生成", layout="centered")
...
# ===== JSON入力＆パワポ生成セクション =====
st.header("📝 STEP 8: 企画書生成")
st.markdown("左側のアプリからコピーしたJSONデータを貼り付けます。")

# JSON入力欄の高さを少し抑える
json_text = st.text_area("JSONデータを貼り付け", height=150, label_visibility="collapsed", placeholder="ここにJSONデータを貼り付けてください")
